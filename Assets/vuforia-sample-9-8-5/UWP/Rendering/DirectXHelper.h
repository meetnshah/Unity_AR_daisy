...
namespace winrt::DX
{
    ...
    inline concurrency::task<std::vector<byte>> ReadDataAsync(const hstring& filename)
    {
    ...
    inline D3D11_BLEND_DESC CreateBlendDesc(bool transparent) {
    ...
    inline D3D11_RASTERIZER_DESC CreateRasterizerDesc(
